...
public enum Reply {
    ...
    /**
     * Sent to notify a client of an invitation to a client,
     * as well as to inform the inviting user of a successful
     * invitation.<br />
     * Parameters: nick, target nick, channel
     */
    RPL_INVITING            ("341 %s %s %s", 3),
    ...
    /**
     * Sent if a command targets a nick that does not exist.<br />
     * Parameters: nick, target nick
     */
    ERR_NOSUCHNICK          ("401 %s %s :No such nickname", 2),
